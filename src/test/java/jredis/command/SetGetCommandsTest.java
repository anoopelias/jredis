...
public class SetGetCommandsTest {
    ...
    public static String[] SET_EX_PX_COMBINATION = { "Rahul", "Dravid", "EX",
            "100", "PX", "100" };

    public static String[] SET_PX_NO_TIME = { "Rahul", "Dravid", "PX" };
    public static String[] SET_EX_NO_TIME = { "Rahul", "Dravid", "EX" };
    public static String[] SET_PX_INVALID_TIME = { "Rahul", "Dravid", "PX",
            "NX" };
    public static String[] SET_EX_INVALID_TIME = { "Rahul", "Dravid", "EX",
            "XX" };

    public static String[] SET_PX_XX_COMBINATION = { "Rahul", "Gandhi", "PX",
            "100", "XX" };
    public static String[] SET_PX_NX_COMBINATION = { "Rahul", "Gandhi", "PX",
            "100", "NX" };
